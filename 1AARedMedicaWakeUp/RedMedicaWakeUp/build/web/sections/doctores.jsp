    ...
    <body style="background-image: url('<%=request.getContextPath()%>/imagenes/gradient_bg.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <h1 style="text-align: center; font-weight: 900; color: gray; margin-top: 50px;">Tus Doctores</h1>
                <%
                    String imagenusu = "";
                    String nombreusu = "";
                    String apeusu = "";
                ...
                <%
                    ResultSet rs = null;
                    rs = con.consulta("call traepacientes('2','" + UsrId + "')");
                            if (!rs.isBeforeFirst()) {%>
                <script>

                    //setTimeout('redirec()',2000);
                    swal({title: "Aun no tienes doctores", type: "warning", animation: "slide-from-top"},
                            function () {
                                window.location = "InicioRed.jsp";
                            });
                </script>
                ...
                <form class="usubuscado puntero" action="chat.jsp" method="post">
                    <div data-us="<%=rs.getString("idpersona")%>" fname="goto" class="image">
                        <img data-us="<%=rs.getString("idpersona")%>" fname="goto" class="imgusubuscado" src="<%=request.getContextPath()%>/UsrImagenes/<%=rs.getString("imagen")%>"></div>
