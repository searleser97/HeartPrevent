...
public class Mail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String correohaciacomun = request.getParameter("n1");
            String opc=request.getParameter("opc");
            String correohacia=cifrado.encriptaAES(correohaciacomun);
            ResultSet rs = con.consulta("call validaMail('" + correohacia + "')");
            if (rs.next()) {
...
int seEnvioConfirmacion=0;
                switch (opc){
                    case "1":
                message.setSubject("Recuperacion de Contraseña HeartPrevent");
                 String mailHtmlrecupera="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n" +
...
"<style type=\"text/css\">body,html,.body{background:#f3f3f3!important;}.header{background:#f3f3f3;}</style>\n" +
"<body>\n" +
" \n" +
...
"</tbody>\n" +
"</table>\n" +
"<h2 class=\"text-center\">HeartPrevent</h2> </th>\n" +
"<th></th>\n" +
"</tr>\n" +
"</table>\n" +
"</th>\n" +
...
"</tbody>\n" +
"</table>\n" +
"<center data-parsed=\"\"> <img src=\"https://scontent.felp1-1.fna.fbcdn.net/v/t1.0-9/12295241_193893030950422_3658469584859884673_n.png?oh=6fceaaa28dddd853fd3e52638dba97e8&oe=57A48A90\" align=\"center\" style=\"height: 100px; width: 100px;\" class=\"float-center\"> </center>\n" +
"<table class=\"spacer\">\n" +
"<tbody>\n" +
"<tr>\n" +
"<td height=\"16px\" style=\"font-size:16px;line-height:16px;\">&#xA0;</td>\n" +
...
"</tbody>\n" +
"</table>\n" +
"<h4 class=\"text-center\">"+rs.getString("nombre")+", ¿Olvidaste tu contraseña?</h4>\n" +
"<table class=\"spacer\">\n" +
"<tbody>\n" +
"<tr>\n" +
"<td height=\"16px\" style=\"font-size:16px;line-height:16px;\">&#xA0;</td>\n" +
...
"</tbody>\n" +
"</table>\n" +
"<p class=\"text-center\">Da click en el siguiente recuadro para proceder con el proceso de recuperación.</p>\n" +
...
"<tr>\n" +
"<td>\n" +
"<a href=\"http://"+myIp+":8080/HPNet/sections/passrecovery.jsp?m="+rs.getString("contraseña")+rs.getString("correo")+"\" align=\"center\" class=\"float-center\"\"><center data-parsed=\"\">Recupera tu contraseña</center></a>\n" +
"</td>\n" +
"</tr>\n" +
"</table>\n" +
"</td>\n" +
...
"</table>\n" +
"<hr>\n" +
"<p><small>WakeUp inc. All rights Reserved.</small></p>\n" +
"</th>\n" +
...
"</body>\n" +
"</html>";
                message.setContent(mailHtmlrecupera,"text/html; charset=utf-8");
//                message.setText("Para continuar con el proceso de reestablecimiento de su contraseña de click en el siguiente enlace:"
//                        + "\n\nhttp://"+myIp+":8080/HPNet/sections/passrecovery.jsp?m="+rs.getString("contraseña")+rs.getString("correo")+""
//                        + "\n\n"
//                        + "\n\n Si has recibido este mensaje por error, es probable que otro usuario haya introducido sin darse cuenta tu dirección de correo electrónico al intentar restablecer una contraseña."
//                        + "Si no has iniciado el proceso de solicitud, no es necesario que hagas nada al respecto y puedes ignorar este mensaje tranquilamente."
//                        +"\n\n"+Fecha);
                
                break;
                        case "2":
                            seEnvioConfirmacion=1;
                            
                message.setSubject("Confirmacion de cuenta HeartPrevent");
                String emailHtmlConfirmaa="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n" +
"<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
"<head>\n" +
"<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n" +
"<meta name=\"viewport\" content=\"width=device-width\">\n" +
...
"</tbody>\n" +
"</table>\n" +
"<h4 class=\"text-center\">"+rs.getString("nombre")+", Bienvenido a HeartPrevent!.</h4>\n" +
"<table class=\"spacer\">\n" +
"<tbody>\n" +
"<tr>\n" +
"<td height=\"16px\" style=\"font-size:16px;line-height:16px;\">&#xA0;</td>\n" +
...
"</tbody>\n" +
"</table>\n" +
"<p class=\"text-center\">Para confirmar tu cuenta haz click en el siguiente recuadro.</p>\n" +
"<table class=\"button large expand\"\">\n" +
"<tr>\n" +
"<td>\n" +
"<table>\n" +
"<tr>\n" +
"<td>\n" +
"<a href=\"http://"+myIp+":8080/HPNet/sections/confirmacion.jsp?m="+rs.getString("contraseña")+rs.getString("correo")+"\" align=\"center\" class=\"float-center\"\"><center data-parsed=\"\">Confirma tu cuenta</center></a>\n" +
"</td>\n" +
"</tr>\n" +
"</table>\n" +
"</td>\n" +
...
"</body>\n" +
"</html>";
                message.setContent(emailHtmlConfirmaa,"text/html; charset=utf-8");
//                message.setText("Para confirmar su cuenta de click en el siguiente enlace:"
//                        + "\n\nhttp://"+myIp+":8080/HPNet/sections/confirmacion.jsp?m="+rs.getString("contraseña")+rs.getString("correo")+""
//                        + "\n\n" + Fecha);
                ...
                if(seEnvioConfirmacion==1){
                    con.consulta("call validaUsr('3','"+cifrado.encriptaAES(correohaciacomun)+"','0')");
                }
                out.print("si");
            } else {
                out.print("no");
